...
function HeroSection() {
  ...
  <div className="w-[1391px] h-[444px] flex justify-center items-center gap-[138px]">
    <div className="flex-col justify-start items-start gap-6 inline-flex">
        ...
        <div className="w-[557px] text-black text-lg font-normal ">Embark on a transformative journey with us—beyond biases, towards unity. We're dedicated to breaking down barriers, fostering a world where equality triumphs over discrimination. Join our movement for a future where unity prevails</div>
